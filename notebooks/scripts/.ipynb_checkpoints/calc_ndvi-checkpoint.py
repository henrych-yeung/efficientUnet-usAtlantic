...
os.chdir(os.getcwd())
# baseImgDir = "../../source"
file_prefix = 'repro_raw_'
baseImgDir = "/Users/apm5rt/Library/CloudStorage/OneDrive-UniversityofVirginia/code_deepLearning/dryland_U-Net_NorthCarolinaDeadOnly2016_SM_ver20230519/rawImage_test20230518_reproj"
...
for im in tqdm(inputImages):
    ...
    outputName_ndvi = inputImage.replace(file_prefix, "repro_ndvi_")
