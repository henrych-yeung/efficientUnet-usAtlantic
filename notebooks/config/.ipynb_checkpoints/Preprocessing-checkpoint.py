...
class Configuration:
    ...
    def __init__(self):
        ...
        self.training_base_dir = '/scratch/apm5rt/efficientUnet-usAtlantic/training'
        self.training_area_fn = 'trainingArea_train.gpkg'
        self.training_polygon_fn = 'trainingPolygon.gpkg'

        # For reading the VHR images
        self.bands = [0,1,2,3]
        self.raw_image_base_dir = '/scratch/apm5rt/efficientUnet-usAtlantic/training/images'
        self.raw_image_file_type = '.tif'
        self.raw_ndvi_image_prefix = 'reproj_raw'
        ...
        self.path_to_write = '/scratch/apm5rt/efficientUnet-usAtlantic/output_train'
        ...
        self.path_to_write = os.path.expanduser("~/../../scratch")
